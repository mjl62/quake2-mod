...
// End Stats
// Items for RPG mod 
// HEALTH POT CANNOT BE 0 IT DOESNT WORK RIGHT IN MENU
#define RPGITEM_HEALTHPOT		1
#define RPGITEM_MAGICKAPOT		2
#define RPGITEM_FATIGUEPOT		3
#define RPGITEM_LEVITATEPOT		4
#define RPGITEM_FORTIFYPOT		5
#define RPGITEM_CHESTARMOR		6
#define RPGITEM_HEADARMOR		7
